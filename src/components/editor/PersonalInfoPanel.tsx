...
import { User, Mail, Phone, MapPin, Globe, Link, FileText, Camera, X } from "lucide-react";
...
export default function PersonalInfoPanel() {
  ...
  const handlePhotoUpload = async (file: File) => {
    ...
    try {
      ...
      setPersonalInfo({ photo: optimized });
    } catch {
      try {
        setPersonalInfo({ photo: await readOriginalPhoto(file) });
      } catch {
